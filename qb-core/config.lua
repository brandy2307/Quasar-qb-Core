...
QBConfig.Money = {}
QBConfig.Money.MoneyTypes = { cash = 2000, bank = 3000, crypto = 0 } -- type = startamount - Add or remove money types for your server (for ex. blackmoney = 0), remember once added it will not be removed from the database!
...
QBConfig.Server.Discord = 'https://discord.lala-land.games'                            -- Discord invite link
